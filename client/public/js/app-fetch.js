...
var _fetch = _interopRequireDefault(require("./API/fetch.js"));
...
var fetchTodos = function fetchTodos() {
  _fetch["default"].get('/todos').then(function (response) {
...
var removeTodo = function removeTodo(id) {
  _fetch["default"]["delete"]("/todos/".concat(id)).then(function (response) {
    return response.json();
  }).then(setTodos)["catch"](console.error);
};
...
var toggleTodo = function toggleTodo(id) {
  ...
  _fetch["default"].patch("/todos/".concat(id), {
    completed: completed
  }).then(function (response) {
    return response.json();
  }).then(setTodos)["catch"](console.error);
...
var removeCompletedAll = function removeCompletedAll() {
  _fetch["default"]["delete"]('/todos/completed').then(function (response) {
    return response.json();
  }).then(setTodos)["catch"](console.error);
};

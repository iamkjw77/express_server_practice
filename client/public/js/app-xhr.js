...
var _xhr = _interopRequireDefault(require("./API/xhr.js"));
...
var fetchTodos = function fetchTodos() {
  _xhr["default"].get('/todos', setTodos);
};
...
var removeTodo = function removeTodo(id) {
  _xhr["default"]["delete"]("todo/".concat(id), setTodos);
};
...
var toggleTodo = function toggleTodo(id) {
  ...
  _xhr["default"].patch("todos/".concat(id), {
    completed: completed
  }, setTodos);
};

var toggleComplete = function toggleComplete(completed) {
  _xhr["default"].patch('/todos', {
    completed: completed
  }, setTodos);
};

var removeCompletedAll = function removeCompletedAll() {
  _xhr["default"]["delete"]('/todos/completed', setTodos);
};
